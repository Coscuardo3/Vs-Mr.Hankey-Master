...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'credits', #end 'options', 'dank'];
	...
	override function create()
	{
		...
		trollFace = new FlxSprite(-80).loadGraphic(Paths.image('MrHankey4K'));
