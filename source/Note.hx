...
class Note extends FlxSprite
{
	...
	public static var scales:Array<Float> = [0.7, 0.7, 0.65, 0.55];
	public static var swidths:Array<Float> = [160, 120, 137, 110];
	public static var posRest:Array<Int> = [0, -160, 20, 50];
