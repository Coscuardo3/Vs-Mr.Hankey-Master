...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var ui_diff = Paths.getSparrowAtlas('difficulties');
		...
		sprDifficulty = new FlxSprite(leftArrow.x + 60, leftArrow.y);
		sprDifficulty.frames = ui_diff;
		sprDifficulty.animation.addByPrefix('easy', 'EASY');
		sprDifficulty.animation.addByPrefix('normal', 'NORMAL');
		sprDifficulty.animation.addByPrefix('hard', 'HARD');
		sprDifficulty.animation.addByPrefix('rip', 'RIP');
		sprDifficulty.animation.addByPrefix('perma', 'PERMA');
		sprDifficulty.animation.play('rip');
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		switch (curDifficulty)
		{
			...
			case 3:
				...
				sprDifficulty.offset.x = 20;
			case 4:
				sprDifficulty.animation.play('perma');
				sprDifficulty.offset.x = 20;	 
		}
