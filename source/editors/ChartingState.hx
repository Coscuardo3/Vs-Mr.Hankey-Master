...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Alp Idle Animation', "Sets a speciied suffix after the idle animation name.\nYou can use this to trigger 'idle-alp' if you set\nValue 2 to -alp\n\nValue 1: Character to set (0 = Dad, 1 = BF, 2 = GF)\nValue 2: New suffix (Leave it blank to disable)"],
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var stepperMania:FlxUINumericStepper = new FlxUINumericStepper(100, 70, 1, 0, 0, 2, 1);
	...
	var check_alpAnim:FlxUICheckBox;
	...
	function addSectionUI():Void
	{
		...
		check_alpAnim = new FlxUICheckBox(110, 60, null, null, "Alp Animation", 100);
		check_alpAnim.checked = _song.notes[curSection].alpAnim;
		check_alpAnim.name = 'check_alpAnim';
		...
		tab_group_section.add(check_alpAnim);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		if (id == FlxUICheckBox.CLICK_EVENT)
		{
			...
			switch (label)
			{
				...
				case "Alp Animation":
					_song.notes[curSection].alpAnim = check.checked;
			}
		}
	...
	function updateSectionUI():Void
	{
		...
		check_alpAnim.checked = sec.alpAnim;
